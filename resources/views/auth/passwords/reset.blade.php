                                    ...
                                    <div class="p-30 pb-0">
                                        ...
                                        <div class="form-group m-t-20 row">
                                            <div class="col-12">
                                                ...
                                                <input class="form-control pl-0 font-12 {{ $errors->has('email') ? ' is-invalid' : '' }} mb-4" type="email" placeholder="Email" name="email" >
                                                @if ($errors->has('email'))
                                        ...
                                        <div class="form-group row m-b-30">
                                            <div class="col-12">
                                                ...
                                                <input class="form-control  pl-0 font-12 {{ $errors->has('password') ? ' is-invalid' : '' }} mb-4"  type="password" name="password" placeholder="password" >
                                        ...
                                        <div class="form-group row m-b-20">
                                            <div class="col-12">
                                                <input id="password-confirm" type="password" class="form-control  pl-0 font-12 mb-4" name="password_confirmation"  placeholder="Confirm password" >
                                            </div>
