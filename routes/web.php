...
Route::get('interview','LoggedInController@interview')->name('interview');
Route::get('interviewdetail/{id}','LoggedInController@interviewdetail')->name('interviewdetail');

Route::post('update/account','LoggedInController@updateAccount')->name('update.account');
Route::post('requestinterview','LoggedInController@requestinterview')->name('requestinterview');
...
Route::get('faith','HomeController@faith')->name('faith');
Route::get('faith-detail/{id}','HomeController@faith_detail')->name('faith-detail');
Route::get('israel','HomeController@israel')->name('israel');
Route::get('bible','HomeController@bible')->name('bible');
...
Route::resource('faith/faith', 'faith\FaithController');

Route::resource('videolinks/videolinks', 'videolinks\VideolinksController');
Route::resource('Israelppt/israelppt', 'Israelppt\IsraelpptController');
